...
export default function DivergenciasTemporadasPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Divergências de Temporadas</h1>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3 bg-gray-50 rounded-lg p-3 space-y-2">
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="font-semibold text-gray-800">{div.p1Seasons} temp / {div.p1Episodes} ep</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-gray-500 font-medium">TMDB (atual)</span>
                          <span className="font-semibold text-gray-800">{div.tmdbSeasons} temp / {div.tmdbEpisodes} ep</span>
                        </div>
      ...
      {pages > 1 && (
        <div className="flex justify-center gap-2 mt-8">
          <button onClick={() => fetchData(page - 1)} disabled={page === 1} className="px-4 py-2 rounded-lg border text-sm disabled:opacity-40 hover:bg-gray-50">
            ← Anterior
          </button>
          <span className="px-4 py-2 text-sm text-gray-600">Página {page} de {pages}</span>
          <button onClick={() => fetchData(page + 1)} disabled={page === pages} className="px-4 py-2 rounded-lg border text-sm disabled:opacity-40 hover:bg-gray-50">
            Próxima →
          </button>
        </div>
      )}
