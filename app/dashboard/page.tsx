...
export default async function DashboardPage() {
  ...
  const cards = [
    ...
    { label: 'Aguardando Atualização', value: stats.awaitingUpdate, icon: RefreshCw, color: 'text-yellow-400', bg: 'bg-yellow-400/10 border-yellow-400/20', href: '/dashboard/atualizações' },
