        ...
        <div className="rounded-2xl p-8" style={{ backgroundColor: '#151515' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input {...register('email')} type="email" placeholder="seu@email.com" className="w-full rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all text-white" style={{ backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a' }} />
